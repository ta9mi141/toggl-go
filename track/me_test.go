	...
	}{
		{
			...
			out: struct {
				...
				me: &Me{
					...
					CreatedAt:          Time(time.Date(2012, time.March, 4, 1, 23, 45, 0, time.FixedZone("", 0))),
					UpdatedAt:          Time(time.Date(2012, time.May, 6, 2, 34, 56, 0, time.FixedZone("", 0))),
					OpenIDEnabled:      Bool(false),
					At:                 Time(time.Date(2012, time.June, 7, 8, 9, 10, 0, time.FixedZone("", 0))),
