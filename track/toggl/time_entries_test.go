				...
				timeEntries: []*TimeEntry{
					{
						...
						Start:           track.Ptr(time.Date(2012, time.March, 4, 5, 6, 20, 0, time.FixedZone("", 0))),
						...
						At:              track.Ptr(time.Date(2022, time.March, 4, 5, 6, 7, 0, time.FixedZone("", 0))),
						ServerDeletedAt: nil,
					...
					},
					{
						...
						TaskID:          nil,
						Billable:        track.Ptr(false),
						Start:           track.Ptr(time.Date(2022, time.January, 2, 3, 47, 41, 0, time.FixedZone("", 0))),
	...
	}{
		{
			...
			out: struct {
				...
				timeEntry: &TimeEntry{
					...
					TaskID:          nil,
					Billable:        track.Ptr(false),
					Start:           track.Ptr(time.Date(2020, time.January, 23, 4, 56, 31, 0, time.FixedZone("", 0))),
					Stop:            nil,
					...
					TagIDs:          []*int{track.Ptr(1234567)},
					Duronly:         track.Ptr(false),
					At:              track.Ptr(time.Date(2020, time.January, 23, 4, 56, 34, 0, time.FixedZone("", 0))),
					ServerDeletedAt: nil,
	...
	}{
		{
			...
			out: struct {
				...
				timeEntry: &TimeEntry{
					...
					TagIDs:          nil,
					Duronly:         track.Ptr(false),
					At:              track.Ptr(time.Date(2022, time.July, 6, 5, 4, 3, 0, time.FixedZone("", 0))),
					ServerDeletedAt: nil,
					UserID:          track.Ptr(1234567),
					UID:             track.Ptr(1234567),
					WID:             track.Ptr(1234567),
	...
	}{
		{
			...
			out: struct {
				...
				timeEntry: &TimeEntry{
					...
					Duronly:         track.Ptr(false),
					At:              track.Ptr(time.Date(2022, time.July, 7, 12, 34, 56, 0, time.FixedZone("", 0))),
					ServerDeletedAt: nil,
					UserID:          track.Ptr(1234567),
					UID:             track.Ptr(1234567),
